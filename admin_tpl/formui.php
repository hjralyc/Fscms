...
<?php echo @$title ;?>
<h1 class="demoHeaders"><a href="admin/user/userpage">UI Design</a></h2>
<div id="uidesign">85%</div>
<h1 class="demoHeaders">Code</h2>
<div id="Code">6%</div>
<br><br>

<h2 class="box_header box-blue">Box title</h1>
<h2 class="box_w_header box-blue">List title</h1>
<h2 class="box_header box-red">Error title</h1>
<h2 class="box_header box-green font-yellow">Complte title</h1>
<h2 class="box_header box-yellow font-black">Message title</h1>
<h2 class="box_header box-violet">Warning title</h1>
...
<div>
	<input id="autocomplete" title="type &quot;a&quot;" class="text">
</div>
...
<ol class="sortable">
    ...
    <li>
        <div>ITEM 1-1</div>
        <ol>
            <li><div>ITEM 1-1-1</div></li>
            <li><div>ITEM 1-1-2</div></li>
        </ol>
    </li>
						...
						<div>
							...
							<div class="fileupload fileupload-new" data-provides="fileupload">
 								<div class="input-append">
    								<div class="uneditable-input span3"><i class="icon-file fileupload-exists"></i> <span class="fileupload-preview"></span></div><span class="btn btn-file"><span class="fileupload-new">Choose file</span><span class="fileupload-exists">Change</span><input type="file" /></span><a href="#" class="btn fileupload-exists" data-dismiss="fileupload">Remove</a>
  								</div>
							</div>
